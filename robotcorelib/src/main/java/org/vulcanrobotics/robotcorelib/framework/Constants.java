...
public class Constants {
    ...
    public static final double ODOMETRY_WHEELBASE = 39.1; // needs recalibration, theoretical value is 36.42
    ...
    public static final double ODOMETRY_HORIZONTAL_TICKS_PER_RAD = 22.7;
    public static final double SHOOTING_OFFSET_RAD = 90 * (Math.PI / 180.0);
